...
And that idea, led to us building Eagleeye, a tool to make use of videos from CCTV feeds, as well as other kinds of videos, captured by people at a crime scene :information_source:.

***Based on a true story***

## What does Eagleeye do? :grey_question:

Eagleeye will help you analyse a video using the following methods:
...
and Eagleeye will extract the audio and split in into sources so you can clearly hear the vocals :speaking_head: and well as the background noise separately and gather useful information
from it :loudspeaker:.

## How does Eagleeye work? :thought_balloon:
...
- [SRResnet Model](https://github.com/abhijitramesh/Eagle-eye/tree/master/superResModel/checkpoint_srresnet.pth.tar)
- [SRGAN Model](https://github.com/abhijitramesh/Eagle-eye/tree/master/superResModel/checkpoint_srgan.pth.tar)
- [Training and Testing Scripts](https://github.com/abhijitramesh/Eagle-eye/tree/master/superRes_Train)
...
- [YOLO Model](https://github.com/abhijitramesh/Eagle-eye/tree/master/yoloModel/yolov3.weights)
- [YOLO Training Scripts](https://github.com/abhijitramesh/Eagle-eye/tree/master/yolo_train)
...
To run the project, just execute the eagleEye.py script. Rest of the files were the ones used to do the intial groundwork of training models and getting them ready by testing them. 
